...
<body>
    <div class="container m-5">
        ...
        <a href="<?php echo e(url('/profileRouteName')); ?>" class="list-group-item list-group-item-action">
        Named Route
        </a> <a href="<?php echo e(url('/route_priority/user')); ?>" class="list-group-item list-group-item-action">
        Route Priority
        </a> <a href="<?php echo e(url('/asdqwezxc')); ?>" class="list-group-item list-group-item-action">
        Fallback Routes
        </a>
...
<?php /**PATH C:\Users\Muhammad Aly Tamam S\Routing\resources\views/routing.blade.php ENDPATH**/ ?>